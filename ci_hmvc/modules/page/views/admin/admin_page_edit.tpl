...
$redirect = "<?=base_url();?>admin/page/page_list/".$this->session->userdata('catalog_id');
}
else{
$redirect = "<?=base_url();?>admin/page";
}
?>
<form class="form-horizontal" action="/admin/page/save" method="post" role="form">
            ...
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade active in" id="content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date form_datetime">
                                <input class="form-control" size="16" type="text" id="edited" name="edited" value="<?=$edited?>" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <span class="btn btn-small col-sm-12 pull-right file-button">
                                ...
                                <input type="file" id="upload_image" name="userfile" onchange="CMSApi.ajax_file_upload('pages', 'Img', 'input_image');
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" rows="5" id="textContent" name="content"><?=htmlspecialchars($content);?></textarea>
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" rows="5" id="short_content" name="short_content"><?=$short_content;?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="tab-pane fade" id="parameters">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <button type="button" class="btn btn-small col-sm-12 pull-right" onclick="CMSApi.urlTranslit('inputName', 'meta_url');
				    return false;"><i class="fa fa-refresh"></i> Автозаполнение</button>
                        </div>
                    </div>
                    <div class="form-group">
